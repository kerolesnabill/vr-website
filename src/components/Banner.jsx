        ...
        <div className="flex flex-col lg:flex-row">
          <div>
            ...
            <p className="font-secondary mb-12 max-w-[440px] mx-auto lg:mx-0">
              ...
              quam id quidem cum accusantium minus.
            </p>
            <div className="flex items-center justify-around space-x-4 max-w-[320px] mx-auto mb-12 lg:max-w-none lg:justify-start">
              <button className="btn">Git it now</button>
              <a
